...
wget -O cek-ws "https://raw.githubusercontent.com/vinstechmy/multiport-websocket/main/XRAY/cek-ws.sh" && chmod +x cek-ws
wget -O del-ws "https://raw.githubusercontent.com/vinstechmy/multiport-websocket/main/XRAY/del-ws.sh" && chmod +x del-ws
wget -O renew-ws "https://raw.githubusercontent.com/vinstechmy/multiport-websocket/main/XRAY/renew-ws.sh" && chmod +x renew-ws
...
wget -O cek-vless "https://raw.githubusercontent.com/vinstechmy/multiport-websocket/main/XRAY/cek-vless.sh" && chmod +x cek-vless
wget -O del-vless "https://raw.githubusercontent.com/vinstechmy/multiport-websocket/main/XRAY/del-vless.sh" && chmod +x del-vless
wget -O renew-vless "https://raw.githubusercontent.com/vinstechmy/multiport-websocket/main/XRAY/renew-vless.sh" && chmod +x renew-vless
...
wget -O cek-tr "https://raw.githubusercontent.com/vinstechmy/multiport-websocket/main/XRAY/cek-tr.sh" && chmod +x cek-tr
wget -O del-tr "https://raw.githubusercontent.com/vinstechmy/multiport-websocket/main/XRAY/del-tr.sh" && chmod +x del-tr
wget -O renew-tr "https://raw.githubusercontent.com/vinstechmy/multiport-websocket/main/XRAY/renew-tr.sh" && chmod +x renew-tr
...
wget -O cek-xray "https://raw.githubusercontent.com/vinstechmy/multiport-websocket/main/XRAY/cek-xray.sh" && chmod +x cek-xray
wget -O del-xray "https://raw.githubusercontent.com/vinstechmy/multiport-websocket/main/XRAY/del-xray.sh" && chmod +x del-xray
wget -O renew-xray "https://raw.githubusercontent.com/vinstechmy/multiport-websocket/main/XRAY/renew-xray.sh" && chmod +x renew-xray
...
wget -O cek-xtr "https://raw.githubusercontent.com/vinstechmy/multiport-websocket/main/XRAY/cek-xtr.sh" && chmod +x cek-xtr
wget -O del-xtr "https://raw.githubusercontent.com/vinstechmy/multiport-websocket/main/XRAY/del-xtr.sh" && chmod +x del-xtr
wget -O renew-xtr "https://raw.githubusercontent.com/vinstechmy/multiport-websocket/main/XRAY/renew-xtr.sh" && chmod +x renew-xtr
...
wget -O certxray "https://raw.githubusercontent.com/vinstechmy/multiport-websocket/main/XRAY/cert.sh" && chmod +x certxray
...
wget -O cek-trgo "https://raw.githubusercontent.com/vinstechmy/multiport-websocket/main/TRGO/cek-trgo.sh" && chmod +x cek-trgo
wget -O del-trgo "https://raw.githubusercontent.com/vinstechmy/multiport-websocket/main/TRGO/del-trgo.sh" && chmod +x del-trgo
wget -O renew-trgo "https://raw.githubusercontent.com/vinstechmy/multiport-websocket/main/TRGO/renew-trgo.sh" && chmod +x renew-trgo
wget -O user-trgo "https://raw.githubusercontent.com/vinstechmy/multiport-websocket/main/TRGO/user-trgo.sh" && chmod +x user-trgo
wget -O port-trgo "https://raw.githubusercontent.com/vinstechmy/multiport-websocket/main/TRGO/port-trgo.sh" && chmod +x port-trgo

# // MENU FILES
echo -e "[ ${green}INFO${NC} ] Downloading Menu Files"
sleep 1
wget -O menu-ws "https://raw.githubusercontent.com/vinstechmy/multiport-websocket/main/SSH/menu-ws.sh" && chmod +x menu-ws
wget -O menu-vless "https://raw.githubusercontent.com/vinstechmy/multiport-websocket/main/SSH/menu-vless.sh" && chmod +x menu-vless
wget -O menu-tr "https://raw.githubusercontent.com/vinstechmy/multiport-websocket/main/SSH/menu-tr.sh" && chmod +x menu-tr
wget -O menu-xray "https://raw.githubusercontent.com/vinstechmy/multiport-websocket/main/SSH/menu-xray.sh" && chmod +x menu-xray
wget -O menu-xtr "https://raw.githubusercontent.com/vinstechmy/multiport-websocket/main/SSH/menu-xtr.sh" && chmod +x menu-xtr
wget -O menu-trgo "https://raw.githubusercontent.com/vinstechmy/multiport-websocket/main/SSH/menu-trgo.sh" && chmod +x menu-trgo
