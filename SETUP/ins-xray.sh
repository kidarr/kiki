...
iptables -I INPUT -m state --state NEW -m tcp -p tcp --dport 10083 -j ACCEPT
iptables -I INPUT -m state --state NEW -m tcp -p tcp --dport 10084 -j ACCEPT
iptables -I INPUT -m state --state NEW -m tcp -p tcp --dport 10085 -j ACCEPT

iptables -I INPUT -m state --state NEW -m udp -p udp --dport 10083 -j ACCEPT
iptables -I INPUT -m state --state NEW -m udp -p udp --dport 10084 -j ACCEPT
